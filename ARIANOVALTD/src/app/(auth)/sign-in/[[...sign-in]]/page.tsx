      ...
      <SignIn 
        ...
        appearance={{
          ...
          elements: {
            ...
            identityPreviewText: "font-sans font-semibold tracking-widest text-[#4A0404]",
            identityPreviewEditButtonIcon: "text-[#4A0404]",
            formResendCodeLink: "text-[#4A0404] font-bold uppercase tracking-widest text-[10px]",
          }
        }}
      />
    </motion.div>
