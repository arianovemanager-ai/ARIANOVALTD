...
export default async function Home() {
  ...
  return (
    <div className="flex-1 flex flex-col bg-[#F9F6EE]">
      ...
      {/* Identity Section */}
      <section className="bg-[#4A0404] text-[#F9F6EE] py-32 px-6 relative z-10">
        <div className="container mx-auto max-w-4xl text-center">
          <FadeInView direction="up">
            <div className="w-12 h-px bg-[#F9F6EE]/30 mx-auto mb-12" />
            ...
            <p className="text-lg md:text-xl text-[#F9F6EE]/80 leading-relaxed font-light max-w-3xl mx-auto">
      ...
      {/* Wine Grid */}
      <section id="wines" className="container mx-auto px-6 py-20 border-t border-[#4A0404]/10">
